...
class SettingsPresenter extends BasePresenter {
	...
	protected function createComponentElementGrid($name){
		...
		$grid = $this->createGrid($this, $name, 'WebCMS\FormModule\Doctrine\Element', array(),
			array(
	...
	public function actionUpdateElement($idPage, $id){
		...
		if($id) $this->element = $this->elementRepository->find($id);
		else $this->element = new \WebCMS\FormModule\Doctrine\Element;
	}
